namespace GHCtoMania
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.BlueValue_l = new System.Windows.Forms.Label();
			this.Blue_l = new System.Windows.Forms.Label();
			this.YellowValue_l = new System.Windows.Forms.Label();
			this.Yellow_l = new System.Windows.Forms.Label();
			...
			// GreenValue_l
			// 
			this.GreenValue_l.AutoSize = true;
			...
			// Red_l
			// 
			this.Red_l.AutoSize = true;
			this.Red_l.Location = new System.Drawing.Point(7, 42);
			this.Red_l.Name = "Red_l";
			this.Red_l.Size = new System.Drawing.Size(27, 13);
			this.Red_l.TabIndex = 4;
			this.Red_l.Text = "Red";
			// 
			// BlueValue_l
			// 
			this.BlueValue_l.AutoSize = true;
			...
			// YellowValue_l
			// 
			this.YellowValue_l.AutoSize = true;
			...
			// OrangeValue_l
			// 
			this.OrangeValue_l.AutoSize = true;
			...
			this.Controls.Add(this.BlueValue_l);
			this.Controls.Add(this.Blue_l);
			this.Controls.Add(this.YellowValue_l);
			this.Controls.Add(this.Yellow_l);
		...
		private System.Windows.Forms.Label BlueValue_l;
		private System.Windows.Forms.Label Blue_l;
		private System.Windows.Forms.Label YellowValue_l;
		private System.Windows.Forms.Label Yellow_l;
